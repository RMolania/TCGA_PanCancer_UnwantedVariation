...
We're currently in the final stages of developing an R package to facilitate the quick and straightforward implementation of the RUV-III-PRPS method [here](https://github.com/RMolania/RUVIIIPRPS/tree/Ramyar-M)
